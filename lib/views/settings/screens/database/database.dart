...
class Database extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final SettingItem export = SettingItem(
      title: 'Exportar',
    ...
    final List<Widget> settingItems = <Widget>[
      SettingItem(
        title: 'Importar',
                                    ...
                                    onPressed: () async {
                                      ...
                                      if (result != null) {
                                        ...
                                        if (platFile.path == null || platFile.extension != 'db') {
                                          error = true;
                                        } else if (await DatabaseHelper().isValidDatabase(platFile.path!)) {
    ...
    return Scaffold(
      ...
      body: Obx(() {
        if (bronzeController.bronzes.isNotEmpty) {
          settingItems.insert(0, clean);
        }
        if (bronzeController.bronzes.isNotEmpty || clientController.clients.isNotEmpty) {
          settingItems.add(export);
        }
        return Center(
          child: SafeArea(
